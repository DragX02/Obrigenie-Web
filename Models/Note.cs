namespace Obrigenie.Models
{
    ...
    public class Note
    {
        ...
        // Contexte complet de la sélection en cascade (Année → Visée à maîtriser), une ligne
        // par niveau, composé côté client à l'enregistrement et affiché dans le calendrier.
        // Null si aucune visée n'est rattachée.
